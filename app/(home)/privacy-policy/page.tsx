...
const PrivacyPolicy: React.FC = () => {
  const sections = [
    ...
    },
    {
      ...
      description:
        "The Company collects the following Personal Information from all its users:",
      content: [
        "Mobile number",
      ...
      subdesc:
        "We may also collect Non-Personal Information, including location, browser information, internet protocol address, information collected through Cookies, details of Your internet service provider, and other technologies.",
    },
    {
    ...
    },
    {
      ...
      content: `Our security systems and process are compliant with applicable laws. Onx By Awign Enterprises takes careful precaution to protect our User's personal information from unauthorised access, improper use or disclosure or unauthorised modification. To prevent unauthorised access, We have put in place the latest industry-standard security technology and procedures to safeguard the information we collect online.`,
    },
    {
      title: "5. Storage and Data Retention Policy",
      content: `You agree and acknowledge that We shall retain all information provided by You until such time as required by the Us or is otherwise required under the applicable laws for the time being in force. We may retain Your information being engaged as a Project Participant for perpetuity, unless specifically requested by You for deletion of the same from our systems.`,
    },
    {
    ...
    },
    {
      ...
      content: `If You have any compliant or grievances or concerns with respect to Platform or this Privacy Policy, please inform such matters to the designated Grievance Officer as mentioned below in writing or through electronic mail:`,
      contact: {
        name: "Mr. Praveen Sah",
