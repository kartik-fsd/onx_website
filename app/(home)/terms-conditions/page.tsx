...
const TermsAndConditionsPage = () => {
  ...
  const sections = [
    {
      title: "Agreement",
      content: `This Onx Work Program – Terms and Conditions ("Agreement") between Awign Enterprises Private Limited, a private limited company incorporated under the Companies Act, 1956 ("Company") and the participant mentioned in the AWP Participation Offer ("Project Participant") governs and provides the terms and conditions in relation to the Project Participant's participation in the Onx Work Program ("AWP").`,
    },
    {
      title: "Obligations of the Project Participant",
      content:
        'The Project Participant shall: (a) undertake, provide and complete such tasks, assignments, works, and other services as are identified in AWP Participation Offer; (b) ensure that upon completion of tasks, assignments, works and other services identified under the AWP Participation Offer, all the materials related to the same, including content, records, notes, designs, presentations, word/ excel document and other written or printed materials or materials in any electronic media or in other media whatsoever ("Works"), are returned to the Company for its records and possession.',
    },
    {
      title: "Rights of the Company",
      content:
        "The Project Participant hereby agrees that the Company has the sole and exclusive right: (a) over all the Works as 'work for hire', all of which at all stages of development shall be the sole and exclusive property of the Company; (b) to amend, modify, alter this Agreement at any time with prior notice to the Project Participant; and (c) to approach any other project participant for the tasks, assignments, works and other services to be rendered under the AWP Participation Offer.",
    },
    {
    ...
    },
    {
      title: "Payment",
      content:
        "Payment shall be made by the Company to Project Participant subject to payment terms as set forth in AWP Participation Offer. The contract-based refund policy is applicable. No other refunds are applicable.",
    },
    {
    ...
    },
    {
      title: "Grievances",
      content:
        "Any grievance can be reported to the grievance officer specifically dedicated to address all concerns. Grievance officer can be contacted at support@awign.com",
    },
    {
      title: "Access opt-out",
      content:
        "Users are provided with clear and accessible means to revoke their consent. This includes the provision of unsubscribe links within our marketing emails, dedicated settings within user accounts, and access to our support team, which is available to assist in the deactivation of accounts upon request.",
    },
    {
