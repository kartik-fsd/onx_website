...
import MenuSelect from "@/components/ui/selectMenu";
import DynamicBodyField from "@/components/ui/dynamicSelect";
import TextAreaField from "@/components/ui/textArea";
import { BlogFormData, BodyField } from "@/components/types/post";
import { showToast, Toast } from "@/components/ui/toast";
import customResolver from "@/components/types/resolver";
...
const AdminPage = () => {
  ...
  const handleAuthorSelect = (selectedAuthor: { id: number }) => {
    // Change id to number
    setValue("authorId", selectedAuthor.id.toString());
  };
      ...
      <div className="max-w-4xl mx-auto bg-white shadow-xl rounded-lg p-10">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
          ...
          <div className="mt-8">
            ...
            <MenuSelect onSelect={handleAuthorSelect} />
          </div>
