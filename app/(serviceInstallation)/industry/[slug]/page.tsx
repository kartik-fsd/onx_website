...
import { industryData } from "@/app/assets/data/industryData";
    ...
    <>
      <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <div className={`bg-gradient-to-r ${industry.color} p-8`}>
          ...
          >
            ...
            <p className="text-xl text-gray-600 mb-8">
              In addition to merchant onboarding, Onx also offers partner
              onboarding services for the {industry.name} industry. Our major
              partner onboarding services include:
            </p>
