...
import Onx from "@/app/assets/images/Onx";
    ...
    <header className="bg-white shadow-sm shadow-slate-300">
      ...
      >
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          {/* <Link
            href="/login"
            className="inline-flex items-center px-4 py-2 border border-gray-800 text-sm font-semibold leading-6 text-gray-800 hover:text-white hover:bg-orange-600 rounded-md transition duration-300"
          >
            Login{" "}
