  ...
  const steps = [
    {
      ...
      description:
        "Streamline workforce integration with tailored onboarding. We use rigorous criteria, in-app interviews, and provide specialized training via pre-recorded materials and live webinars.",
    },
    {
      title: "Deployment & Execution",
      description:
        "Optimize project execution with our comprehensive strategy. We assess job details, streamline applications, and closely monitor throughout the execution phase.",
    },
    {
      title: "Project Configuration",
      description:
        "Enhance efficiency with precise setup. We configure your project on our Work/Task Execution platform, mapping out steps and stages for optimal performance.",
    },
    {
      title: "Quality Checks",
      description:
        "Ensure superior outcomes with rigorous quality assurance. We scrutinize qualitative and quantitative feedback, maintaining high standards throughout your project.",
    },
    {
      title: "Reporting & Analytics",
      description:
        "Gain valuable insights with comprehensive reporting. We provide detailed reports covering all key points, empowering data-driven decision-making.",
    },
  ];
  return (
    <section
