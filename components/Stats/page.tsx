...
// <h2 className="xl:text-5xl md:text-4xl text-2xl font-semibold leading-tight text-center text-indigo-800  sm:mb-0 mb-12">
//   Empowering India’s Workforce with ONX
//   <br className="md:block hidden" />
// </h2>
// <h3 className="mt-2 text-indigo-700 opacity-90 text-2xl font-semibold leading-tight text-center">
//   Bridging Gaps in the Gig Economy
// </h3>

//         <div className="md:mt-14 mt-4 relative sm:flex items-center justify-center">
//           {/* Desktop and Tablet Background */}
//           <Image
//             src="https://i.ibb.co/KjrPCyW/map.png" // Replace this with an India map image URL
...
//           {/* Mobile Background */}
//           <Image
//             src="https://i.ibb.co/SXKj9Mf/map-bg.png" // Replace this with a relevant India map image for mobile
//             alt="India map mobile background"
...
//               500K+
//             </p>
//             <p className="text-base leading-4 xl:mt-4 mt-2 text-gray-600 dark:text-gray-300">
//               Professionals Engaged Nationwide
//             </p>
//           </div>
//           {/* Data Point 2 */}
//           <div className="shadow-lg xl:p-6 p-4  sm:w-auto w-full bg-white dark:bg-gray-800 sm:absolute relative z-20 sm:mt-0 mt-4 xl:mt-80 xl:-ml-0 sm:-ml-12">
//             <p className="text-3xl font-semibold text-gray-800 dark:text-white">
//               1M+
//             </p>
//             <p className="text-base leading-4 xl:mt-4 mt-2 text-gray-600 dark:text-gray-300">
...
import INDIA_TOPO_JSON from "@/app/assets/data/india.json";
...
const StatCard: React.FC<StatData> = ({ title, value, icon: Icon, color }) => (
  ...
  >
    <div className="flex justify-between items-center mb-2">
      ...
      <span className={cn(`text-${color}-500`, "text-sm font-medium")}>
        {title}
      </span>
    </div>
...
export const IndiaMap: React.FC = () => {
          ...
          <Marker key={city.name} coordinates={city.coordinates}>
            <circle
              ...
              onMouseEnter={() => {
                setTooltipContent(`
                <div class="p-2">
                  <h4 class="font-bold text-lg">${city.name}</h4>
  ...
  return (
    <section
      ...
      id="onx-stats"
    >
      <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center text-indigo-800 mb-2">
        Empowering India&apos;s Businesses with ONX
      </h1>
      <h2 className="text-md sm:text-lg md:text-xl font-semibold font-sans text-center text-gray-600 mb-8">
