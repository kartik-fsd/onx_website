...
import { Reason } from "@/app/assets/data/whychoose";
...
const AnimatedStat: React.FC<Stat> = ({ value, unit, prefix }) => {
  ...
  return (
    <div className="text-4xl font-bold text-white">
      ...
      <span className="text-2xl font-normal">{unit}</span>
    </div>
  );
};
    ...
    <section className="w-full mx-auto py-8 px-16 bg-gradient-to-br from-indigo-100 to-purple-100">
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="lg:w-2/3">
          <div
            className={`bg-gradient-to-br ${reasons[activeIndex].color} rounded-xl p-8 shadow-lg transition-all duration-500`}
          >
